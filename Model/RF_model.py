...
# model construction
model = RandomForestRegressor(n_estimators=100, max_depth=20, min_samples_leaf=1, min_samples_split=2)
...
predictions_df = pd.DataFrame({
    ...
    'RF Predicted logKd': target_predictions
})

output_folder = r"RF_logKd_prediction"

if not os.path.exists(output_folder):
    os.makedirs(output_folder)

predictions_df.to_excel(os.path.join(output_folder, 'RF_Standard_AC_predictions.xlsx'), index=False)